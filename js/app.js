...
$(document).ready(function () {
  ...
  $("#copyadress").on("click", function(){
    if ($('#addressslovakia-street').val()) {
      $('#addressforeign-street').val($('#addressslovakia-street').val());
    }
    if ($('#addressslovakia-streetno').val()) {
      $('#addressforeign-streetno').val($('#addressslovakia-streetno').val());
    }
    if ($('#addressslovakia-city').val()) {
      $('#addressforeign-city').val($('#addressslovakia-city').val());
    }
